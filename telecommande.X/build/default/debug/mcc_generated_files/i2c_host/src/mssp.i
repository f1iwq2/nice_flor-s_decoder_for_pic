...
# 69 "mcc_generated_files/i2c_host/src/../mssp.h"
extern const i2c_host_interface_t I2C1_Host;
# 78 "mcc_generated_files/i2c_host/src/../mssp.h"
void I2C1_Initialize(void);
# 87 "mcc_generated_files/i2c_host/src/../mssp.h"
void I2C1_Deinitialize(void);
# 118 "mcc_generated_files/i2c_host/src/../mssp.h"
_Bool I2C1_Write(uint16_t address, uint8_t *data, size_t dataLength);
# 149 "mcc_generated_files/i2c_host/src/../mssp.h"
...
# 195 "mcc_generated_files/i2c_host/src/../mssp.h"
i2c_host_error_t I2C1_ErrorGet(void);
# 206 "mcc_generated_files/i2c_host/src/../mssp.h"
_Bool I2C1_IsBusy(void);
# 233 "mcc_generated_files/i2c_host/src/../mssp.h"
...
void I2C1_Tasks(void)
{
    if (0U != PIR2bits.BCLIF)
    {
        I2C1_ErrorEventHandler();
    }
    if (0U != PIR1bits.SSPIF)
    {
        if (0U != PIR2bits.BCLIF)
        {
            I2C1_ErrorEventHandler();
